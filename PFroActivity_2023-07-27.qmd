...
ggplot(PFroEngagementSummary, aes(x = Included_In_VBPMeasure, y = Percentage, fill = Received_PFroService)) +
  geom_bar(stat = "identity", position = "dodge") +
  ...
  labs(title = "PFro Services Received by VBP Members",
       x = "Included_In_VBPMeasure"
       ) +
  scale_y_continuous(labels = scales::percent_format(scale = 1)) +  # Format y-axis as percentage
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))  # Rotate x-axis labels at 45 degrees
```
