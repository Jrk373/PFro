...
=======
#| include: false
>>>>>>> 2656bf9eb1e7eb4163b6e5f11fde0550b85dca61
#| echo: false
#| warning: false
#| error: false
...
Next we check to see if any of the people identified so far had an eligible FUH7 inpatient claim. 
...
Now append an indicator for any antidepressant medication. This data is not for the same time period (yet). I borrowed it from the AMM model on a whim.
...
Services to distinct members by provider. T1016 removed.
...
ggplot(stacked_data, aes(x = count, y = ProviderName, fill = isVBP)) +
  ...
  labs(title = "Stacked Bar Chart of Count of Distinct MemberID vs. ProviderName",
