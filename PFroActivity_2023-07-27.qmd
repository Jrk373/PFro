...
kable(summary_table, format = "html", caption = "Summary of PFro Involvement with VBP Measures")
```
...
# Plot for PFro
ggplot(data = filter(summary_df, PFro == "PFro"), aes(x = PFro, y = n, fill = VBP)) +
  geom_bar(stat = "identity") +
  scale_fill_manual(values = my_colors) +
  labs(title = "Summary of PFro and VBP Engagement",
       x = "PFro",
       y = "Count",
       fill = "VBP") +
  theme_minimal() +
...
# Plot for PFro
ggplot(data = filter(summary_df, PFro == "NoPFro"), aes(x = PFro, y = n, fill = VBP)) +
  geom_bar(stat = "identity") +
  scale_fill_manual(values = my_colors) +
  labs(title = "Summary of PFro and VBP Engagement",
       x = "PFro",
