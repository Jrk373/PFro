...
Initial data was collected in collaboration with the Alliance ACO, The Narbha Institute, and Health Choice BCBSAZ. By using the methodology outlined below, we found that 0.002%, or 183 of the 103,487 Alliance ACO members received peer and family run services in the 2022 calendar year. Of those, 0.0002%, or 13 people have were deemed eligible for a HEDIS/NCQA[^1] VBP measure in the 2022 VBP measurement year. The greatest number of non case management services delivered respite services (S5150), family support services (S5110), and peer support services (H0038).
...
The Alliance ACO has a demonstrated secure, systematic approach to data acquisition, preservation, and production. The Alliance has worked in tandem with HC BCBSAZ software developers, quality management and clinical professionals, and finance administration to ensure the most up to date and accurate data is used.  
...
In other words, PFro service providers are currently providing care to 0.2% of the Alliance ACO membership, including 0.002% of VBP eligible members.
